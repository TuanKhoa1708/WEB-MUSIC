...
// ArtistMobileDrawer kept for import compatibility but no longer used
export function ArtistMobileDrawer({ isOpen: _i, onClose: _o }: { isOpen: boolean; onClose: () => void }) {
  return null
}
